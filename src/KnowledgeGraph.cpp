...
inline void KnowledgeGraph::add_edge(size_t src_id, size_t dst_id, size_t relation_id){
...
void KnowledgeGraph::generate_test_set(Node* node, size_t relation_id, bool change_src, 
